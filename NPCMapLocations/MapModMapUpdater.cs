...
// Check for & fetch updates to the modified map page so that
// a new release doesn't have to be created for minor changes
namespace NPCMapLocations
{
    class MapModMapUpdater
    {
        ...
        private static async Task<JObject> GetJsonAsync(string uri)
        {
            ...
            request.UserAgent = "Map Mod Map Updater";
